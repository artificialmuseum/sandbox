export default {
  ...
  version: 2,
  /*
   * will load src/artifact/skybox.jpg
   */
  sky: '/skybox',
  ...
  /*
   * loads /artifact/video.mp4 onto an object in the gltf file.
   * object has to be named "videotarget" and should have as few vertices as possible.
   */
  video: '/artifact',
